...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.TrimBack(150);
    ballet_special1_.MakeLoop(200);
    ballet_special2_.CalcRelativeTranslations();


    ballet_special3_.LoadFromAMC(Platform::FindFile("60_13.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimBack(700);
    ballet_special3_.TrimFront(300);
    ballet_special3_.CalcRelativeTranslations();


    ballet_special4_.LoadFromAMC(Platform::FindFile("61_11.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special4_.TrimBack(1000);
    ballet_special4_.TrimFront(50);
    ballet_special4_.MakeLoop(100);
    ballet_special4_.CalcRelativeTranslations();


    ballet_special5_.LoadFromAMC(Platform::FindFile("55_12.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special5_.TrimBack(500);
